...
from app.crud.verb import (
    add_verb_to_group,
    create_verb_group,
    delete_verb_group,
    get_verb_by_id,
    get_verb_group_by_id,
    get_verb_groups_by_user,
    remove_verb_from_group,
    update_verb_group,
)
from app.database import get_session
from app.models.user import User
from app.schemas.verb import VerbGroupCreate, VerbGroupResponse, VerbGroupUpdate
...
def list_verb_groups(
    ...
    """List verb groups for the current user."""
