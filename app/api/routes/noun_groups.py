...
from app.crud.noun import (
    add_noun_to_group,
    create_noun_group,
    delete_noun_group,
    get_noun_by_id,
    get_noun_group_by_id,
    get_noun_groups_by_user,
    remove_noun_from_group,
    update_noun_group,
)
from app.database import get_session
from app.models.user import User
from app.schemas.noun import NounGroupCreate, NounGroupResponse, NounGroupUpdate
...
def list_noun_groups(
    ...
    """List noun groups for the current user."""
